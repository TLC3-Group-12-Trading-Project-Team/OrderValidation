package com.example.orderValidation.Redis.config;

import com.example.orderValidation.Redis.service.OrderMessageListener;
...
public class RedisConfig {
    ...
    @Bean
    public MessageListenerAdapter orderMessageAdapter(OrderMessageListener orderMessageListener){
